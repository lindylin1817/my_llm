...
print("Start to prepare training data set ===========")
...
valid_dataset = None
print("Start to prepare validation data set ===========")
if jsonl_data_val is not None:
    ...
    valid_dataset = ConversationDatasetV2(conversations_val,
                                            tokenizer=tokenizer,
                                            maxlen=max_seq_len)
print("Start to trainer.do_train for training ===========")
trainer.do_train(
